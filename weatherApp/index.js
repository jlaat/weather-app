...
const changeFeelsLike = (newTemperature) => {
  let divFeelsLike = document.querySelector(".feelsLike").textContent = `Feels like: ${newTemperature} °C`;
}
const changeWind = (newWind) => {
  let divWind = document.querySelector(".wind").textContent = `Wind: ${newWind} m/s`
}
